...
export const PRESET_VIDEO_MAP: Record<string, string> = {
  ...
  [GANCHO_PACOTE_TRANSPARENTE_PRESET.id]: ganchoPacoteTransparenteVideo,
  [GANCHO_EMBALAGEM_TIKTOK_SHOP_PRESET.id]: ganchoEmbalagemTikTokShopVideo,
  [PASSAR_A_MAO_NA_ROUPA_SITE_PRESET.id]: passarAMaoNaRoupaVideo,
  [MOSTRAR_AS_PECAS_PRESET.id]: mostrarAsPecasVideo,
  [MOSTRAR_O_TECIDO_DE_PERTO_PRESET.id]: mostrarOTecidoDePertoVideo,
  [GANCHO_JOGAR_ROUPA_NA_CAMERA_PRESET.id]: ganchoJogarRoupaNaCameraVideo,
  [GANCHO_TAPAR_CAMERA_COM_A_MAO_PRESET.id]: ganchoTaparCameraComAMaoVideo,
  [GANCHO_ALCA_PRESET.id]: ganchoAlcaVideo,
  [FRENTE_LADO_CABELO_PRESET.id]: frenteLadoCabeloVideo,
  [FRENTE_FOCO_NA_ROUPA_PRESET.id]: frenteFocoNaRoupaVideo,
  [CTA_SIMPATICA_PRESET.id]: ctaSimpaticaVideo,
  [FRENTE_DETALHE_REALISTA_CTA_10SEG_PRESET.id]: frenteDetalheRealistaCta10sVideo,
  [LADO_CTA_FRENTE_CABELO_PRESET.id]: ladoCtaFrenteCabeloVideo,
};
...
export const PRESET_IMAGE_MAP: Record<string, string> = {
  ...
  [COLOCAR_ROUPA_NO_AMBIENTE_PRESET.id]: colocarRoupaAmbienteImage,
  [ROUPA_NO_PACOTE_PRESET.id]: roupaNoPacoteImage,
  [COLOCAR_EMBALAGEM_TIKTOK_PRESET.id]: colocarEmbalagemTikTokImage,
};
...
export const PRESET_DURATION_MAP: Record<string, string> = {
  ...
  [GANCHO_PACOTE_TRANSPARENTE_PRESET.id]: "5s",
  [GANCHO_EMBALAGEM_TIKTOK_SHOP_PRESET.id]: "8s",
  [PASSAR_A_MAO_NA_ROUPA_SITE_PRESET.id]: "8s",
  [MOSTRAR_AS_PECAS_PRESET.id]: "10s",
  [MOSTRAR_O_TECIDO_DE_PERTO_PRESET.id]: "8s",
  [GANCHO_JOGAR_ROUPA_NA_CAMERA_PRESET.id]: "6s",
  [GANCHO_TAPAR_CAMERA_COM_A_MAO_PRESET.id]: "5s",
  [GANCHO_ALCA_PRESET.id]: "8s",
  [FRENTE_LADO_CABELO_PRESET.id]: "8s",
  [FRENTE_FOCO_NA_ROUPA_PRESET.id]: "10s",
  ...
  [COLOCAR_ROUPA_NO_AMBIENTE_PRESET.id]: "Imagem",
  [ROUPA_NO_PACOTE_PRESET.id]: "Imagem",
  [COLOCAR_EMBALAGEM_TIKTOK_PRESET.id]: "Imagem",
};
